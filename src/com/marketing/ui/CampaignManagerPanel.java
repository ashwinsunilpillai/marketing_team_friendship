...
public class CampaignManagerPanel extends JPanel {
    ...
    private void initializeUI() {
        ...
        // Metrics and header panel
        JPanel topPanel = new JPanel(new BorderLayout(0, 12));
        topPanel.setOpaque(false);
        topPanel.add(createHeader(), BorderLayout.NORTH);
        topPanel.add(createMetricsPanel(), BorderLayout.CENTER);
        ...
        // Filter and Actions panel wrapper
        ...
        contentPanel.add(filterActionsPanel, BorderLayout.NORTH);
    ...
    private JPanel createTablePanel() {
        ...
        campaignTable.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting() && campaignTable.getSelectedRow() >= 0) {
                selectedCampaignId = (Integer) tableModel.getValueAt(campaignTable.getSelectedRow(), 0);
            }
        });
    ...
    private void loadCampaigns() {
        ...
        for (Campaign campaign : campaigns) {
            ...
            Object[] row = {
                    ...
                    "EMAIL", // Type would come from campaign if available
                    campaign.getStatus(),
    ...
    private void applyFilters() {
        ...
        for (Campaign campaign : campaigns) {
            ...
            // Check type filter (always EMAIL for now since type isn't stored in Campaign
            // model)
            if (!selectedType.equals("All Types")) {
                String campaignType = "EMAIL"; // This would come from campaign if available
    ...
    private void handleEdit() {
        ...
        JOptionPane.showMessageDialog(this, "Edit Campaign ID: " + selectedCampaignId, "Edit Campaign",
                JOptionPane.INFORMATION_MESSAGE);
    }
