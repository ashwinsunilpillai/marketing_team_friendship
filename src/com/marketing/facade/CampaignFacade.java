...
public class CampaignFacade {
    ...
    public boolean createCampaign(Campaign campaign) throws CampaignCreationException {
        ...
        String sql = "INSERT INTO campaigns (campaign_name, start_date, end_date, budget, status, segment_id, description, lead_target, leads_generated) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = dbUtil.getConnection();
            ...
            pstmt.setInt(8, campaign.getLeadTarget());
            pstmt.setInt(9, campaign.getLeadsGenerated());
    ...
    public boolean updateCampaign(Campaign campaign) throws CampaignNotFoundException {
        ...
        String sql = "UPDATE campaigns SET campaign_name = ?, start_date = ?, end_date = ?, budget = ?, status = ?, segment_id = ?, description = ?, lead_target = ?, leads_generated = ? WHERE campaign_id = ?";
        ...
        try (Connection conn = dbUtil.getConnection();
            ...
            pstmt.setInt(8, campaign.getLeadTarget());
            pstmt.setInt(9, campaign.getLeadsGenerated());
            pstmt.setInt(10, campaign.getCampaignId());
    ...
    private Campaign mapResultSetToCampaign(ResultSet rs) throws SQLException {
        ...
        if (rs.findColumn("lead_target") > 0) {
            campaign.setLeadTarget(rs.getInt("lead_target"));
        }
        if (rs.findColumn("leads_generated") > 0) {
